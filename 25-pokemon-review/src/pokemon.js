...
//   pokemon.sprites.front = `https://img.pokemondb.net/sprites/heartgold-soulsilver/normal/${pokemon.name}.png`
//   pokemon.sprites.back = `https://img.pokemondb.net/sprites/heartgold-soulsilver/back-normal/${pokemon.name}.png`
// })