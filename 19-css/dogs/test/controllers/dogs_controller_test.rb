...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { integer: @dog.integer, name: @dog.name, tail_length: @dog.tail_length } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { integer: @dog.integer, name: @dog.name, tail_length: @dog.tail_length } }
