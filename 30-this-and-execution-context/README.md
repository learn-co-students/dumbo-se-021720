...
```rb
class Dog
  attr_accessor :first, :snacks

  def initialize(first, snacks) 
    @first = first
    @snacks = snacks
  end 
  ...
  def speak
    ...
    "woof my name is #{self.first}"
  end

  def self.all
    # in Ruby, self in an class method refers to the class.
    "woof my name is #{self}"
  end


end

dog = Dog.new("fezzik", ["pb"])
